...
def test_validate():
    ...
    #               should be correct data type)
    # copy line multiple times to run multiple tests (with different parameters)
    results.append(runTest('validate(1, 1, 1970)', True))
    results.append(runTest('validate(9, 31, 2000)', False))
    results.append(runTest('validate(2, 29, 2017)', False))
    results.append(runTest('validate(2, 28, 2017)', True))
    printResults(results)
